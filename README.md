...
<span style="color:#9ece6a">✔</span> <b>Network Operations</b>
  └─ MikroTik, Debian Hardening, DNS/DHCP
<span style="color:#9ece6a">✔</span> <b>Low-Level Engineering</b>
  └─ C++ Native Apps (Qt), System Utils
<span style="color:#9ece6a">✔</span> <b>Environment</b>
  └─ Linux Kernel, Bash Scripting, Vim

<span style="color:#7aa2f7">user@padli</span>:<span style="color:#bb9af7">~</span>$ <span style="animation: blink 1s infinite;">_</span>
</pre>
